...
By using Figure \ref{fig:heatmap_japan_combined} and Figure \ref{fig:heatmap_sweden_combined} we can get a sense of which days are better than others, e.g. that Saturdays and Sundays seem not so good as there are fewer updates. 
