...
Vi har kigget på test data fra en periode og for specifikke brugere, fra production data. Herefter har vi kigget på alt data i production data, som Sony havde på daværende tidspunkt. Vi vil beskrive hvordan henholdsvis test data og production data ser ud mht. distributioner mm. 

\subsection{Test data}
Dette data's periode strakte sig over 3 måneder: fra september - november 2015. 
