...
En ting er at kunne se hvordan opdateringer fordeler sig pr. dag pr. bruger, men vi ved ikke om alle opdateringerne for en dag, foregår i løbet af en time eller om de er fordelt henover dagen. Det ville være bedst at kunne finde brugere som har opdateringer på flere tidspunkter i løbet er f.eks. en måned, da der er bedre sandsynlighed for, at disse brugere har co-occurences. 
...
\begin{figure}[H]
    ...
    \caption{Plot over number of users which have location updates in certain percentage unique timebins in each sub-period. A sub-period is defined in section \ref{ssec:methods_and_results}, which is a period devided in three. In all month is a month a sub-period}
    \label{fig:users_by_criteria}
\end{figure}
Fra section \ref{ssec:methods_and_results} ved vi, at vi deler vores valgte periode op i tre subperioder, for at kunne træne og teste på disse. Figure \ref{fig:users_by_criteria} viser, hvor mange brugere der har lokations opdateringer i en vis procentdel af unikke timebins i alle tre subperioder for en givet periode. F.eks. kan vi se, at der er ca 90 brugere som har opdateringer i 20\% af de mulige timebins i hver af de tre subperioder i september i Sverige. Her er septembers 30 dage delt op i følgende subperioder: 1-10, 11-20, 21-30
