...
\begin{figure}[H]
    ...
    \caption{ROC AUC of mean of Logistic Regression (LR) and Random Forest (RF) in the four model-pairs (TP-1, TP-2, PP-1, PP-2). The mean is done over GridSearch and K-fold cross-validation with $K=3$. }
    \label{fig:rocs}
\end{figure}
\begin{figure}[H]
    \hspace*{-1.0cm}
    ...
    \caption{ROC AUC of mean of Logistic Regression (LR) and Random Forest (RF) in the four model-pairs (TP-1, TP-2, PP-1, PP-2). The mean is done over GridSearch and K-fold cross-validation with $K=3$, and with undersampling of the biggest class}
