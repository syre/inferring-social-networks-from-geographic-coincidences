...
The total number of co-occurrences between users. Feature ID:\it{0}.

\subsubsection{Timely arrival and leaving}
We use the timely arrival and leaving measure taken from the master's thesis of P. Sapieżyński\cite{IMM2013-06556}. Feature ID:\it{1}.
...
It exists in two forms, one using Shannon entropy another using Rényi entropy, we will use Shannon. Feature ID:\it{2}.
...
The number of unique co-occurrences in terms of spatial bins between two users. Feature ID:\it{3}.
...
Weighted frequency is a measure of how important the co-occurrences at non-popular places are. Feature ID:\it{4}.
...
We use the weighted co-occurrences measure taken from the master's thesis of P. Sapieżyński\cite{IMM2013-06556}. Feature ID:\it{5}.

\subsubsection{Common travels}
Common travels. Feature ID:\it{6}.

\subsubsection{2 unique co-occurrences}
2 unique co-occurrences. Feature ID:\it{7}.

\subsubsection{mutual co-occurrences}
Number of mutual co-occurrences. Feature ID:\it{8}.

\subsubsection{within 6 years of age}
Whether they are within 6 years of age of each other. Feature ID:\it{9}

\subsubsection{same gender}
Whether they are the same gender. Feature ID:\it{10}

\subsubsection{Jaccard index similarity of used apps}
The Jaccard index is a measure used in comparing the similarity of sample sets. We extract what apps two users have used in the period and compute the similarity between them using the Jaccard index. Feature ID:\it{11}.
