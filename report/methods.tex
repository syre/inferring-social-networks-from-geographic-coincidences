...
\end{itemize}
For each of these pairs (TP-1, PP-1, TP-2, PP-2), the Random Forest will be compared with the baseline (the Logistic Regression in the pair). 
\section{Results}
