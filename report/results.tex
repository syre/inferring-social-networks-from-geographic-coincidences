...
We can see that all of the test data have more negative samples that positive samples. In TP-1 are there much more negative sample than positive, while in TP-2 the different aren't so big. In production data 
