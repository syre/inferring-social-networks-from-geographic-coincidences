...
The performance of the models improve, when filtering the users on cross-occupancy. We assume filtering on cross-occupancy reduces the presence of users which meet in the next period but lack location updates to confirm it.

We found that the most important features between datasets were mutual co-occurrences and specificity, co-occurrences weighted and weighted frequency.