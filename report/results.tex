...
We found two outliers in specificity (12) for PP-2 which does not make sence because they has values way over 1 which should not could happen. There were also strange outliers in feature 7, 3, 2 and 4. When we removed the two outliers from specificity, the strange outliers in the other features disapeared. This meant there were two persons which had bad features for some reasons. We do not know why and how these occurred. 
\section{Summary}
