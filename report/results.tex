...
Next we try to look at the differences in features between the meet and non-meets of the TP-2 and PP-2 dataset. We chose to look at both because TP-2 represents more features but PP-2 represents data for regular users.

Looking at Figure \ref{fig:feature_boxplots1} to \ref{fig:feature_boxplots5} for the TP-2 dataset, we can see features which have very little variance like number of weekends, evenings and common travels. For Co-occurrences weighted we can note a slightly higher mean for the class did meet. For the homophily features, being within 6 years is higher for the did meet group, we see no significant difference relating to gender. Diversity and weighted frequency have large outliers. Looking at the plots, weighted frequency and especially diversity, is higher for did meet. A large diversity signifies a user pair with a very large number of locations between them, which seems to be more common for people who meet in the next period.
Specificity holds higher values for the did meet class.

As number of co-occurrences, mutual co-occurrences and specificity have higher medians for the class did meet, and two of the three also contributed most to the importances for our features, we regard those as most important for predicting did meet for TP-2.
...
\end{figure}
Looking at Figure \ref{fig:feature_boxplots1_pp2} to Figure \ref{fig:feature_boxplots3_pp2} which explains the features of PP-2, we see lower medians for the features: number of co-occurrences, mutual co-occurrences, and specificity.
...
We also found a larger number of people which met in the period, were within 6 years of age for the TP-2 dataset, which might suggest homophily of age plays a part for people who did meet.