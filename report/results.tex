...
\end{figure}
For TP-2 is it features 8 (mutual co-occurrences), 12 (specificity), 4 (weighted frequency) and 5 (co-occurrences weighted) that are the most important. Feature 10 (number of evenings) contributes again very little. 

Since we havn't implementet the same amount of features for PP-2 and TP-2, is it difficult to compare them. Though we can see that top 4 features are the same for PP-2 and TP-2. 
