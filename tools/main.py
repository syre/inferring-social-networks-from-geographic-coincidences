...
class Run():
    ...
    def update_all_data(self):
        ...
        X_train, y_train = self.predictor.generate_dataset(users, countries, locations_train, coocs_train, coocs_met_in_next_train, first_period_datetime_min, first_period_datetime_max)
        print("processing dataset for machine learning (test)")
        X_test, y_test = self.predictor.generate_dataset(users, countries, locations_test, coocs_test, coocs_met_in_next_test, second_period_datetime_min, second_period_datetime_max)
