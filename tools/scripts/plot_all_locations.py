...
if country == "Sweden":
    ...
    plt.annotate("Sony Mobile", xy=(x, y), xytext=(x2, y2), xycoords='data', textcoords='data', arrowprops=dict(arrowstyle="fancy", color='k'), fontsize=20)
    x, y = m(ericsson_coords[0], ericsson_coords[1])
    x2, y2 = m(ericsson_coords[0]-2.3, ericsson_coords[1]+0.5)
    plt.annotate("Ericsson", xy=(x, y), xytext=(x2, y2), xycoords='data', textcoords='data', arrowprops=dict(arrowstyle="fancy", color='k'), fontsize=20)
    x, y = m(sony_coords[0], sony_coords[1])
    x2, y2 = m(sony_coords[0]+0.3, sony_coords[1]-0.6)
    plt.annotate("Sony", xy=(x, y), xytext=(x2, y2), xycoords='data', textcoords='data', arrowprops=dict(arrowstyle="fancy", color='k'), fontsize=20)
elif country == "Japan":
